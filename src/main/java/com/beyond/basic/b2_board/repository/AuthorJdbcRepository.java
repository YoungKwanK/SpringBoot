...
//
//            ps.executeUpdate(); // 추가, 수정의 경우는 excutedUpdate, 조회는 excuteQuery
...
//            while (rs.next()) {
//                authors.add(new Author(rs.getLong("id"),rs.getString("name"), rs.getString("email"), rs.getString("password")));
//            }
//            return authors;
//        } catch (SQLException e) {
//            throw new RuntimeException(e);
...
//            PreparedStatement ps = connection.prepareStatement(sql);
//            ps.setLong(1, id);
//            ps.executeUpdate(); // 추가, 수정의 경우 excuteUpdate, 조회는 excuteQuery
//        } catch (SQLException e) {
//            throw new RuntimeException(e);
//        }
//    }
